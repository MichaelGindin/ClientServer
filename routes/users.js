    ...
    if (errors.length > 0) {
        ...
        request(verifyURL, async(err, response, body) => {
            ...
            if (body.success !== undefined && !body.success) {
                ...
                if (userExistCheck) {
                    errors.push({ msg: 'Sorry but this email already in use, please try another email' });
                    flagSendMail = 0;
                }
        ...
        function sendEmail1(source) {
            ...
            transporter.sendMail(mailOptions, function(error, info) {
                if (error) {
                    ...
                    res.send("The profile has been updated! and email sent to you to change your mail!")
                }
            });
        }
